...
void DataAndStatistics::printShort() {
  ...
  cout << "number of nodes in trace \t" << num_trace_nodes_ << endl;
  cout << "number of edges in trace \t" << num_trace_edges_ << endl;
  //FIXME for model counting
  // cout << "\n# solutions " << endl;
  // print_final_solution_count();
  cout << "\n# satisfying probability = ";
  cout << setprecision(7)  << final_solution_prob_ << endl;
  cout << "\n# END" << endl << endl;
